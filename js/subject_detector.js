// ============================================================
// Subject Detection Engine — maps exam titles to GATE CSE subjects
// ============================================================
// Keywords derived from exhaustive analysis of Exams_structure.txt
// covering: PYQ, GateAtZeal (2025/2026), GO Classes, GATE Overflow,
// GATEBOOK-2019, Test by Bikram, Applied Course, and other sources.
// ============================================================
const GATE_SUBJECTS = [
    {
        id: 'algorithms',
